...
namespace VisualizerControl
{
    ...
    public partial class Visualizer : UserControl
    {
        ...
        {
            Visualizer3DCoreInterface.MoveCamera(newPosition, newDirection, upDirection);
        }
        ...
        {
            Visualizer3DCoreInterface.MoveCamera(newPosition);
        }
        ...
        {
            Visualizer3DCoreInterface.LookAt(newPosition, target, upDirection);
        }
        ...
        {
            Visualizer3DCoreInterface.AutoCameraAdjust();
        }
        ...
        public bool AutoCamera
        {
            set
            {
                Visualizer3DCoreInterface.SetAutoCamera(value);
            }
        }
