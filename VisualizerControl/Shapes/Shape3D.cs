...
namespace VisualizerControl.Shapes
{
    ...
    abstract public class Shape3D(string shapeName, bool freezeMesh = true)
    {
        ...
        public static Shape3D CreateShape(DongUtility.Shapes.Shapes3D shape)
        {
            return shape switch
            {
                DongUtility.Shapes.Shapes3D.Cube => new Cube3D(),
                DongUtility.Shapes.Shapes3D.Sphere => new Sphere3D(),
                DongUtility.Shapes.Shapes3D.Cylinder => new Cylinder3D(),
